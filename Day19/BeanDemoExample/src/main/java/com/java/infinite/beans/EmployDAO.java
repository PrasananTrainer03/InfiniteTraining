...
public class EmployDAO {
	...
	public String addEmploy(Emp employ) throws ClassNotFoundException, SQLException {
		connection = ConnectionHelper.getConnection();
	...
	public String updateEmploy(Emp employ) throws ClassNotFoundException, SQLException {
		connection = ConnectionHelper.getConnection();
	...
	public Emp[] showEmploy() throws ClassNotFoundException, SQLException {
		...
		return employList.toArray(new Emp[employList.size()]);
	}
}
