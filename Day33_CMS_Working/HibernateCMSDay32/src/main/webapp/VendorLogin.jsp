...
<%@ page import="com.java.hib.cms.VendorDAO" %>
...
<body background="agent0.jpg">

 <jsp:useBean id="bean1" class="com.java.hib.cms.Vendor"/>
	...
	<%
			...
			session.setAttribute("user",bean1.getVEN_USERNAME());
